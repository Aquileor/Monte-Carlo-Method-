...
public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("How many points do you want the Monte Carlo method to run?");
            Console.Write("\nInput answer: ");
